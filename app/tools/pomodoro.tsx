...
import { Play, Pause, RotateCcw, Timer, Coffee, Target } from 'lucide-react-native';
      ...
      >
        <View className="flex-row items-center gap-3">
          <View className="w-12 h-12 rounded-[10px] bg-white/20 items-center justify-center">
            <Icon as={Timer} className="text-white" size={24} strokeWidth={2.2} />
          </View>
          <View className="flex-1">
            <Text className="text-white font-bold text-[22px]">番茄钟</Text>
            <Text className="text-white/80 text-[13px] mt-1">专注与休息自动轮换</Text>
          </View>
        </View>
      </View>
